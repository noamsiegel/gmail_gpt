...
for i in range(num_of_messages, num_of_messages - 3, -1):
	...
	# keys = email_message.keys()
	# for key in keys:
	# 	print(key)
	gmail_id = email_message['X-Gmail-Message-Id']
	...
	if len(chunks) <= 10:
		logging.info("Chunks picked")
		for chunk in chunks:
			logging.info("Creating Document object")
	...
	if documents:
		...
		logging.warning("Too many chunks")
		print("CHUNKS:",len(chunks))
		print("SENDER:", sender)
		print("SUBJECT:", subject)
		# print(email_url)
